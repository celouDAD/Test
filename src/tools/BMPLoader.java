...
public class BMPLoader {
    ...
    public static void compareImage(String imgPath1, String imgPath2){  
        ...
        if(!img1.exists()) {
        	System.out.println(imgPath1+"文件不存在");
        }else if (!img2.exists()) {
			System.out.println(imgPath2+"文件不存在");
		}else {
    ...
    public static void main(String[] args){  
        BMPLoader.compareImage("D:\\eclipse-workspace\\Test\\source\\3.jpg", "D:\\eclipse-workspace\\Test\\source\\5.png");  
    }  

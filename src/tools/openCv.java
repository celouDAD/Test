...
public class openCv {
	...
	public static void main(String[] args) {
		...
		Mat g_tem = Imgcodecs.imread("D:\\eclipse-workspace\\Test\\source\\1.jpg");
		Mat g_src = Imgcodecs.imread("D:\\eclipse-workspace\\Test\\source\\2.jpg");
	    ...
	    Imgproc.rectangle(g_src, matchLocation,
	        ...
	        new Scalar(0, 0, 0, 0));
        Imgcodecs.imwrite("D:\\eclipse-workspace\\Test\\source\\new_diff7.png", g_src);
        
//        if(g_tem.empty()) {
//			System.out.println("找不到源文件1");
//		}else if (g_src.empty()) {
//			System.out.println("找不到源文件2");
//		}else {
//			int result_rows = g_src.rows() - g_tem.rows() + 1;
//		    int result_cols = g_src.cols() - g_tem.cols() + 1;
//		    Mat g_result = new Mat(result_rows, result_cols, CvType.CV_32FC1);
